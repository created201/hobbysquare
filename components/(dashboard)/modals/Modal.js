...
const Modal = ({show}) => {
    return(
        <>
            {show && 
            <section className="flex flex-col justify-center fixed left-[50%] left-1/2 transform -translate-x-1/2 -translate-y-1/3 lg:-translate-y-1/4 z-40 py-10 border-solid border-2 bg-theme-white rounded-md text-center w-10/12 lg:w-7/12 lg:h-1/2">
                <div className="flex flex-col items-center">
                    <AiOutlineMail className="w-[8rem] h-[8rem]" />
                    <p className="font-bold text-3xl p-2 mb-5">Confirm</p>
                    <p className="p-2">Are you Sure You Want to Send Email?</p>
                </div>
